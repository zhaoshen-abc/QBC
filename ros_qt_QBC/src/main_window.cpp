...
//    QBCui.Label_page5_5->setStyleSheet("QLabel{background-color:rgb(204, 255, 204);border-bottom:2px groove rgba(0, 0, 0, 0.25);border-radius: 18px;padding:2px 2px;border-style: outset;}");
    ...
    ReadSettings();
    setWindowIcon(QIcon("://images/icon/无人机.png"));
    ...
    **********************/
    ...
    QBCui.GraphicsView_page3->setScene(scene);
    QBCui.GraphicsView_page4->setScene(scene);

    QPixmap image("://images/icon/无人机.png");
...
{
    pixmapItem->setPos(qnode.msg.pose.position.x,qnode.msg.pose.position.y);
//    pixmapItem->update();
}
